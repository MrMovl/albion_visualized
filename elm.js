...
var Elm = {};
Elm['AlbionRecipes'] = Elm['AlbionRecipes'] || {};
if (typeof _user$project$AlbionRecipes$main !== 'undefined') {
    _user$project$AlbionRecipes$main(Elm['AlbionRecipes'], 'AlbionRecipes', undefined);
}
